...
# Record with Provenance (Schema)

`ogc.bbr.template.records-prov` *v0.1*

AOGC API Record item with a provenance trace supporting the PROV-O model and DAG (directed acyclic graph) through both object nesting and references
